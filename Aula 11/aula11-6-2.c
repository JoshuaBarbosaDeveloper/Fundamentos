...
int main(){
  int vectorA[20], counter, number_equal30 = 0, sum_vector = 0; //Declara as variáveis para contadores e vetores;

  for (counter=0; counter<20; counter++){ //Enquanto contador for menor que 8
      ...
      if (vectorA[counter]==30){
          number_equal30 = number_equal30 + 1;
      }
  }

  printf("Soma: %d\n", sum_vector); //Exibe o valor do vetor sum_vector
  printf("Numero igual a 30: %d\n", number_equal30);
  printf("\n" );
